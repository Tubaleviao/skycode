...
function Thunder(options) {
    ...
    this.color = options.color || '#5555ff';
    this.glow = options.glow || '#5555ff';
    ...
    this.render = function(ctx) {
        ...
        light.addColorStop(0, 'rgba(0, 0, 100, 0.6)');
        light.addColorStop(0.1, 'rgba(0, 0, 100, 0.2)');
        light.addColorStop(0.4, 'rgba(0, 0, 100, 0.06)');
        light.addColorStop(0.65, 'rgba(0, 0, 100, 0.01)');
        light.addColorStop(0.8, 'rgba(0, 0, 100, 0)');
        ctx.beginPath();
        ctx.fillStyle = light;
...
function Text(options) {
    ...
    this.color = options.color || '#0000ee';
    this.delay = options.delay || 0;
    this.basedelay = this.delay;
    buffer.font = `${this.size}px Decovar`; //Lucida Console
